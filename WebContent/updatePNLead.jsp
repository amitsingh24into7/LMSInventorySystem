...
function storeItemDetails(itemAction)
{
	...
	parameters = "leadID="+leadID+"&engineType="+engineType+"&engineMakeType="+engineMakeType+"&itemQty="+itemQty+"&itemAmount="+itemAmount+"&itemHz="+itemHz+"&itemVoltage="+itemVoltage+"&createdBy="+createdBy+"&coolingSystem="+coolingSystem+"&alternator="+alternator+"&itemAction="+itemAction;
	}
	else{
		dtlID=document.getElementById("dtlID").value;
		parameters = "leadID="+leadID+"&engineType="+engineType+"&engineMakeType="+engineMakeType+"&itemQty="+itemQty+"&itemAmount="+itemAmount+"&itemHz="+itemHz+"&itemVoltage="+itemVoltage+"&createdBy="+createdBy+"&coolingSystem="+coolingSystem+"&alternator="+alternator+"&itemAction="+itemAction+"&dtlID="+dtlID;
                            ...
                            <div class="tab-content">
								...
								<br />
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
												<label path="dgType">Type</label>
												<select path="dgType" id="dgType" name="dgType"  class="form-control">
													<option value="0">Select Type</option>  <span class="text-alert-danger">*</span>
