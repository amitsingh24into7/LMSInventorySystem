	    ...
	    if(http.readyState == 4) {
	      //  alert(http.responseText);
			...
			if(type=="engine")
			{
				...
				if(a[0].DEFAULT_ALTERNATOR_MODEL=="undefined" || a[0].DEFAULT_ALTERNATOR_MODEL==undefined || a[0].DEFAULT_ALTERNATOR_MODEL=="" || a[0].DEFAULT_ALTERNATOR_MODEL==null)
				{
					alternator="";
				}
				else{
					alternator=a[0].DEFAULT_ALTERNATOR_MODEL;
				}
				...
				document.getElementById("alternatorMakeType").value=a[0].DEFAULT_ALTERNATOR_MAKE;
				document.getElementById("EngineModel").value=a[0].ENGINE_MODEL;
				document.getElementById("DGModel").value=a[0].DG_MODEL;
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
                                            	...
                                            	<select  class="form-control" name="projectType" id="projectType" onchange="return getLeadNo('create')">
										...
										<div class="col-lg-3">
											<div class="form-group">
												<label path="dgType">DG Type</label> <span class="text-alert-danger">*</span>
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" path="customerName" maxlength="100" id="mcustomerName" value="${sel_customerName}" class="form-control" name="customerName" />
