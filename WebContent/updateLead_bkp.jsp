...
parameters=parameters+"&customergroup="+customergroup+"&customergroup_person="+customergroup_person+"&customergroup_person_contact="+customergroup_person_contact+"&createdBy="+createdBy+"&actionValue="+actionValue;
//alert(parameters);
...
function storeItemDetails()
{
	...
	if(engineType==0)
	{
		alert("Please Choose Engine Type");
	...
	var parameters = "leadID="+leadID+"&engineType="+engineType+"&engineMakeType="+engineMakeType+"&itemQty="+itemQty+"&itemAmount="+itemAmount+"&itemHz="+itemHz+"&itemVoltage="+itemVoltage+"&createdBy="+createdBy+"&coolingSystem="+coolingSystem;
	...
	http.onreadystatechange = function() { //Handler function for call back on state change.
	    if(http.readyState == 4) {
	      //  alert(http.responseText);
			...
			document.getElementById("itemHz").value='';
                        ...
                        <div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input path="competitions" type="text" value="${competitions}" id="competitions" class="form-control" name="competitions"/>
											</div>
										</div>
                            ...
                            <br />
								...
								<h4>Customer Address & Other details</h4>
									...
									<h4>Customer Group & End Customer details</h4>
									<hr />
									<div class="row">
										<div class="col-lg-4">
												<div class="form-group">
											...
											<div class="col-lg-4">
												<div class="form-group">
													...
													<input type="text" path="customergroup_person_contact" value="${customergroup_person_contact}" class="form-control" name="customergroup_person_contact" id="customergroup_person_contact" />
												</div>
											</div>
																...
																<div class="row">
																	...
																	<div class="col-lg-3">
																		<div class="form-group">
																			...
																			<input type="text" path="itemHz" value="${itemHz}" class="form-control" id="itemHz" name="itemHz" />
									...
									<div class="row" id="addComments">
										<div class="col-lg-12">
											<div class="panel panel-primary">
		                                    	...
		                                    	<div id="collapseComments" class="panel-collapse collapse" aria-expanded="false" >
			                                        <div class="panel-body">
														<form id="UploadForm" action="UploadFile" method="post" enctype="multipart/form-data" >
															...
															<div align="middle"><input type="submit" value="Submit" id="commentsSubmitButton"  class="btn btn-success" onclick="hideSubmit()"/>
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="panel panel-primary">
		                                    	<a data-toggle="collapse" href="#collapseAttachement" style="text-decoration:none"  >
													<div class="panel-heading" style="color: #fff; background-color: #337ab7;border-color: #337ab7;">
														Attachment  Details
													</div>
												</a>
			                                    <div id="collapseAttachement" class="panel-collapse collapse in" aria-expanded="false" >
			                                    	<div class="panel-body">
														<div class="dataTable_wrapper">
							                                <table class="table table-striped table-bordered table-hover">
							                                    <thead>
