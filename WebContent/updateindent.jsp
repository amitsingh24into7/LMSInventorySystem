...
function GenerateIndentReport()
{
	...
	projectType=document.getElementById("projectType").value;
	projectExeState=document.getElementById("projectExeState").value;
	indentNo=document.getElementById("indentNo").innerHTML;
	
	
	var parameters = "leadID="+leadID+"&projectType="+projectType+"&val="+indentNo+"&state="+projectExeState;
	//alert(parameters);
...
function getAllIndentDetails(leadID,id,val)
{

	var http = new getXMLHttpRequestObject();
	var url = "GetIndentDetails";
	leadID=leadID;
	item_id=id;
	var parameters = "leadID="+leadID+"&dtl_id="+item_id+"&indentAction="+val;
	    ...
	    if(http.readyState == 4) {
	       // alert(http.responseText);
			...
			if(val=="TECHDETAIL")
			{
				...
				document.getElementById("fuleTank").value=jsdata[0].FUEL_TANK;
				document.getElementById("engineOptionals").value=jsdata[0].ENGINE_OPTIONAL;
				document.getElementById("alternatorOptionals").value=jsdata[0].ALTERNATOR_OPTIONAL;
				document.getElementById("panelOptionals").value=jsdata[0].PANEL_OPTIONAL;
				document.getElementById("soloparallel").value=jsdata[0].SOLOPARALLEL;
				document.getElementById("panelType").value=jsdata[0].TYPE_OF_PANEL;
				document.getElementById("testingProcedure").value=jsdata[0].TESTING_PROCEDURE;
				document.getElementById("dgTesting").value=jsdata[0].DG_TESTING;
				if(jsdata[0].TESTING_CHARGES_INCLUDED==1)
					{
					document.getElementById("testingCharges").checked='true'
					}
				else
					{
					document.getElementById("testingCharges").checked='false';
					}
			}
			...
			if(val=="DGPRICING"){
				...
				{
				if(jsdata[i].NAME=="commercialDGPrice")
				{
					document.getElementById("commercialDGPrice").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialexcise")
				{
					document.getElementById("commercialexcise").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialCESS")
				{
					document.getElementById("commercialCESS").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialSHEC")
				{
					document.getElementById("commercialSHEC").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialTOTAL")
				{
					document.getElementById("commercialTOTAL").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialVAT")
				{
					document.getElementById("commercialVAT").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialEntrytax")
				{
					document.getElementById("commercialEntrytax").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialOCTROI")
				{
					document.getElementById("commercialOCTROI").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialAnyOther")
				{
					document.getElementById("commercialAnyOther").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialFI")
				{
					document.getElementById("commercialFI").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialsubTOTAL")
				{
					document.getElementById("commercialsubTOTAL").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialNoofDG")
				{
					document.getElementById("commercialNoofDG").value=jsdata[i].VALUE;
				}
				if(jsdata[i].NAME=="commercialFinalTOTAL")
				{
					document.getElementById("commercialFinalTOTAL").value=jsdata[i].VALUE;
				}
			}
			...
			if(val=="DGPAYMENT"){
				...
				document.getElementById("commercialDGAdvance").value=jsdata[0].ADVANCE;
				document.getElementById("commercialDGcheque").value=jsdata[0].CHEQUE_NO;
				document.getElementById("commercialDGchequedate").value=jsdata[0].CHEQUE_DATE;
				document.getElementById("commercialDGBank").value=jsdata[0].BANK_DETAILS;
				document.getElementById("commercialDGBalance").value=jsdata[0].BALANCE;
				document.getElementById("commercialDGForms").value=jsdata[0].FORMS_TEXT;
				document.getElementById("commercialDGPaymentTerms1").value=jsdata[0].PAYMENT_TERMS1;
				document.getElementById("commercialDGPaymentTerms2").value=jsdata[0].PAYMENT_TERMS2;
				document.getElementById("commercialDGPaymentTerms3").value=jsdata[0].PAYMENT_TERMS3;
				document.getElementById("commercialDGPG").value=jsdata[0].PG_TEXT;
				document.getElementById("commercialDGLiqDamage").value=jsdata[0].LIQUIDATE_DAMAGE_TEXT;


				
			}
			if(val=="INSTPAYMENT"){
				document.getElementById("commercialINSTAdvance").value=jsdata[0].ADVANCE;
				document.getElementById("commercialINSTcheque").value=jsdata[0].CHEQUE_NO;
				document.getElementById("commercialINSTchequedate").value=jsdata[0].CHEQUE_DATE;
				document.getElementById("commercialINSTBank").value=jsdata[0].BANK_DETAILS;
				document.getElementById("commercialINSTBalance").value=jsdata[0].BALANCE;
				document.getElementById("commercialINSTForms").value=jsdata[0].FORMS_TEXT;
				document.getElementById("commercialINSTPaymentTerms1").value=jsdata[0].PAYMENT_TERMS1;
				document.getElementById("commercialINSTPaymentTerms2").value=jsdata[0].PAYMENT_TERMS2;
				document.getElementById("commercialINSTPaymentTerms3").value=jsdata[0].PAYMENT_TERMS3;
				document.getElementById("commercialINSTPG").value=jsdata[0].PG_TEXT;
				document.getElementById("commercialINSTLiqDamage").value=jsdata[0].LIQUIDATE_DAMAGE_TEXT;
				
			}
			if(val=="INSTPRICING"){
				for(i=0;i<jsdata.length;i++)
					{
						if(jsdata[i].NAME=="commercialpipes")
						{
							document.getElementById("commercialpipes").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="commercialpipesVAT")
						{
							document.getElementById("commercialpipesVAT").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="commercialCables")
						{
							document.getElementById("commercialCables").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="commercialCablesVAT")
						{
							document.getElementById("commercialCablesVAT").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="commercialInstTotalDGAccess")
						{
							document.getElementById("commercialInstTotalDGAccess").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="lowSidemateriaSupply")
						{
							document.getElementById("lowSidemateriaSupply").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="lowSidemateriaSupplyVAT")
						{
							document.getElementById("lowSidemateriaSupplyVAT").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="labourinstallation")
						{
							document.getElementById("labourinstallation").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="installationlabourvat")
						{
							document.getElementById("installationlabourvat").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="sublowsideworks")
						{
							document.getElementById("sublowsideworks").value=jsdata[i].VALUE;
						}
						if(jsdata[i].NAME=="totalprojectvalue")
						{
							document.getElementById("totalprojectvalue").value=jsdata[i].VALUE;
						}
			...
			if(val=="SUPPLYSCOPE"){
				document.getElementById("warranty_info").value=jsdata[0].WARRANTY_DETAILS;
				if(jsdata[0].OPERATOR_REQUIRED=="YES")
					{
						document.getElementById("operator_required").checked='true';
					}
				else
					{
					document.getElementById("operator_required").checked='false';
					}
				
				document.getElementById("factoryName").innerHTML=jsdata[0].FACTORY_NAME;
				document.getElementById("branchName").innerHTML=jsdata[0].BRANCH_NAME;
				
				
				factoryScope=jsdata[0].FACTORY_SUPPLY_SCOPE;
				branchScope=jsdata[0].BRANCH_SUPPLY_SCOPE;
				factoryScope=factoryScope.split(",");
				branchScope=branchScope.split(",");
				for(i=0;i<factoryScope.length;i++)
					{
						factoryindex=factoryScope[i].split("=")[0];
						factoryval=factoryScope[i].split("=")[1];
						if(document.factorysupplyscopeForm.elements[i].type=="checkbox"){
							if(document.factorysupplyscopeForm.elements[i].value==factoryindex)
								{
									if(factoryval==1)
										{
										document.factorysupplyscopeForm.elements[i].checked=true;
										}
									else
										{
											document.factorysupplyscopeForm.elements[i].checked=false;
										}
								}
						
						}
					}
				for(i=0;i<branchScope.length;i++)
				{
					branchindex=branchScope[i].split("=")[0];
					brachval=branchScope[i].split("=")[1];
					if(document.branchsupplyscopeForm.elements[i].type=="checkbox"){
						if(document.branchsupplyscopeForm.elements[i].value==branchindex)
							{
								if(brachval==1)
									{
									document.branchsupplyscopeForm.elements[i].checked=true;
									}
								else
									{
										document.branchsupplyscopeForm.elements[i].checked=false;
									}
							}
				 ...
				 <li><a href="index.jsp"><i class="fa fa-home fa-fw"></i> Home</a></li>
				   <li class="dropdown active">
			          ...
			          <ul class="dropdown-menu">
              			<li><a href="MainController?action=listQualifiedLead&search=All">Create Indent</a></li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
													...
													<c:choose>
															...
															<c:otherwise>
																...
																View Indent Details - <span id="indentNo">${indentNo}</span>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <c:choose>
																	<c:when test="${lroleId=='Project'}">
																																
								<li class="" id="LeadcreateIndentTab"><a href="#LeadcreateIndent" data-toggle="tab" aria-expanded="false">Generate Indent Report</a>
                                </li>		
															   ...
															   <c:forEach items="${leadItemsList}" var="leadItems"> 
																	...
																	<c:choose>
																		<c:when test="${lroleId=='Project'}">
																			...
																			<!--  Only For Project Role -->
																			<a href="#" title="Click Here to Update Schedule" data-id="${leadItems.DTL_ID}" data-title-id="Edit Schedule"  data-lead-id="${leadItems.LEAD_ID}" data-engine="${leadItems.DTL_ENGINE_MODEL}" data-qty="${leadItems.DTL_QTY}" data-alternator="${leadItems.DTL_ALTERNATOR_MODEL}" data-amount="${leadItems.DTL_AMOUNT}" class="fa fa-edit fa-2x" data-toggle="modal" data-target="#myModal"></a>
                                    ...
                                    <div class="row" id="viewValidateMessage">
										...
										<div class="well well-transparent">
																	  <div style="font-size: 15px; line-height: 1.5em;">
																		<i class="fa fa-check-circle"></i> Please click here to generate Indent Report  
																		
																		<button class="btn btn btn-primary" onclick="return validateMessage()" style="float:right">Generate</button>
																						...
																						<div class="form-group">
																							...
																							<c:choose>
																										<c:when test="${lroleId=='Project'}">
																											...
																											<input type="button" value="Submit" id="priceDGUpdateButton"  class="btn btn-success" onclick="storePriceInfo('DG','Update')" />		
																						...
																						<div class="form-group">
																							...
																							<c:choose>
																										<c:when test="${lroleId=='Project'}">
																											...
																											<input type="button" value="Submit" id="PaymenttermsDGUpdateButton"  class="btn btn-success" onclick="storePaymentTerms('DG','Update')" />		
																						...
																						<div class="form-group">
																							...
																							<c:choose>
																								<c:when test="${lroleId=='Project'}">
																									...
																									<input type="button" value="Submit" id="priceInstUpdateButton"  class="btn btn-success" onclick="storePriceInfo('INST','Update')" />
																						...
																						<div class="form-group">
																							...
																							<c:choose>
																								<c:when test="${lroleId=='Project'}">
																									...
																									<input type="button" value="Submit" id="PaymenttermsINSTUpdateButton"  class="btn btn-success" onclick="storePaymentTerms('INST','Update')" />
					...
					<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="modal fade" id="myTechnicalModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							...
							$('#myTechnicalModal').on('show.bs.modal', function(e) {
									...
									getAllIndentDetails(leadID,itemid,'TECHDETAIL');
							...
							<script>
															...
															TotalAmount();
															leadID=document.getElementById("leadID").value;
															getAllIndentDetails(leadID,"","DGPRICING");
															getAllIndentDetails(leadID,"","DGPAYMENT");
															getAllIndentDetails(leadID,"","INSTPRICING");
															getAllIndentDetails(leadID,"","INSTPAYMENT");
															getAllIndentDetails(leadID,"","SUPPLYSCOPE");
