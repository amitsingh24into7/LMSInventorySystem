				 ...
				 <li><a href="index.jsp"><i class="fa fa-home fa-fw"></i> Home</a></li>
				   <li class="dropdown active">
			          ...
			          <ul class="dropdown-menu">
              			...
              			<li class=active><a href="MainController?action=listIndent&search=All">View Indents</a></li>
							...
							<form role="form" action="/LMSInventorySystem/MainController" method="get" onsubmit="enableSample();">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="hidden" name="action" value="listIndent" />
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								   ...
								   <c:forEach items="${leaddetails1}" var="user">
						                <tr class="gradeA odd" role="row">
						                    <td style="width:20%">
						                    <a href="MainController?action=updateIndent&leadid=<c:out value="${user.LEAD_ID}"/>"><c:out value="${user.LEAD_ID}" />
						                    </a>
						                    ...
						                    <td><c:out value="${user.INDENT_NO}" /></td>
						                   ...
						                   <a href="IndentReport/Indent_report_${user.INDENT_NO}.pdf" target="_blank" style="color:indianred">
