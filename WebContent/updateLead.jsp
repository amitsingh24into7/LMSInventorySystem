...
function storeCustomerDetails()
{
	...
	customerTempAddress=document.getElementById("customerTempAddress").value;
		...
		var customerConsultant=customerConsultant;
	      ...
	      //  alert(http.responseText);
			...
			var output='';
			 ...
			 for(var i=0; i < jsdata.length; i++)
			 {
				...
				output += '</td>';
				output += '<td>';
				output += "<a href=javascript:setLeadItem('"+encodeURIComponent(jsdata[i].DTL_ID)+"','"+encodeURIComponent(jsdata[i].LEAD_ID)+"','"+encodeURIComponent(jsdata[i].DTL_RATING)+"','"+encodeURIComponent(jsdata[i].DTL_ENGINE_MODEL)+"','"+encodeURIComponent(jsdata[i].DTL_ALTERNATOR_MODEL)+"','"+encodeURIComponent(jsdata[i].DTL_VOLTAGE)+"','"+encodeURIComponent(jsdata[i].DTL_QTY)+"','"+encodeURIComponent(jsdata[i].DTL_AMOUNT)+"','"+encodeURIComponent(jsdata[i].DTL_ENGINE_MAKE)+"','"+encodeURIComponent(jsdata[i].DTL_COOLING_SYSTEM)+"','"+encodeURIComponent(jsdata[i].DTL_FLEX1)+"','"+encodeURIComponent(jsdata[i].DTL_HZ)+"','"+encodeURIComponent(jsdata[i].DTL_ALTERNATOR_MAKE)+"','"+encodeURIComponent(jsdata[i].DTL_ENGINE_MODEL)+"','"+encodeURIComponent(jsdata[i].DTL_FLEX2)+"')><p class='fa fa-pencil fa-2x'>  </p></a>";
...
function setChances(str)
{
	...
	if(str=="Won")
	{
		document.getElementById("leadChances").value="G";
		document.getElementById("leadChances").disabled='true';
		
	}
	else{
	document.getElementById("leadChances").disabled='false';
	}
}
</script>
        <div id="page-wrapper">
									...
									<div class="col-lg-3">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<select path="leadStatus" id="leadStatus" value="${leadStatus}" name="leadStatus" class="form-control" onchange="return setChances(this.value)">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<select name="customerConsultantType" id="customerConsultantType" class="form-control" onchange="getConsultantDetails(this.value)">
													...
													<option value="${pmcType}" ${pmcType == sel_consultantType ? 'selected="selected"' : ''}>${pmcType}
													</option>
													</c:forEach>
										...
										<div class="col-lg-3">
											<div class="form-group">
												<label path="customerConsultant">Consultant Name</label>
														...
														<c:choose>
															<c:when test="${sel_consultantType=='Existing'}">
														<select path="consultantName" id="customerConsultant" name="customerConsultant" class="form-control"  onChange="callCustomer(this.value,'consultant')">
														<option value="0">Select</option>
														<c:forEach items="${consultantNames}" var="consultantName">
															<option value="${consultantName}" ${consultantName == customerConsultant ? 'selected="selected"' : ''}>${consultantName}</option>
												    	</c:forEach>
														</select>
									...
									<div class="col-lg-3">
											<div class="form-group">
												...
												<select name="pmcType" id="pmcType" class="form-control" onchange="getPMCDetails(this.value)">
													...
													<c:forEach items="${pmcTypeList}" var="pmcType">
															<option value="${pmcType}" ${pmcType == sel_pmcType ? 'selected="selected"' : ''}>${pmcType}</option>
												 </c:forEach>
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<c:choose>
															<c:when test="${sel_pmcType=='Existing'}">
														
														<select path="pmc" id="pmc" name="pmc"  class="form-control"  onChange="callCustomer(this.value,'pmc')">
														<option value="0">Select</option>
														<c:forEach items="${pmcNames}" var="pmcName">
															<option value="${pmcName}" ${pmcName == pmc ? 'selected="selected"' : ''}>${pmcName}</option>
												    	</c:forEach>
														</select>
														...
														<input type="text" path="pmc" value="${pmc}" class="form-control" name="pmc" id="mpmc"/>				
			                                    ...
			                                    <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" >
			                                        <div class="panel-body">
																<div class="row">
																	...
																	<div class="col-lg-3">
																		<div class="form-group">
																			<label path="itemVoltage">Alternator Make</label>
																			<select  id="alternatorMakeType" name="alternatorMakeType"  class="form-control" >
																			<option value="0">Select</option>
																				<c:forEach items="${alternatorMakeType}" var="altMakeType">
																					<option value="${altMakeType}">${altMakeType}</option>
																				</c:forEach>
																			</select>
																	...
																	<div class="col-lg-3">
																		<div class="form-group">
																			<label path="itemVoltage">Alternator Model</label>
																			<select  id="alternator" name="alternator"  class="form-control" >
																			<option value="0">Select</option>
																				<c:forEach items="${alternatorModelType}" var="altModelType">
																					<option value="${altModelType}">${altModelType}</option>
																				</c:forEach>
																			</select>
															...
															<input type="hidden" path="itemModelNo" value="${itemModelNo}" class="form-control"/>
																...
																<div class="col-lg-3">
																		<div class="form-group">
																			<label path="coolingSystem">DG Model</label>
																			<input type="text" path="DGModel" maxlength="100" value="${DGModel}" class="form-control" id="DGModel" name="DGModel" />
																		</div>
																	</div>
																	<div class="col-lg-3">
																		<div class="form-group">
																			<label path="coolingSystem">Engine Model</label>
																			<input type="text" path="EngineModel" maxlength="100" value="${EngineModel}" class="form-control" id="EngineModel" name="EngineModel" />
																		</div>
																	</div>
																</div>
														...
														<div class="dataTable_wrapper">
							                                <table class="table table-striped table-bordered table-hover">
															   ...
															   <c:forEach items="${leadItemsList}" var="leadItems"> 
																	...
																	<tr>
																	<td>
																	${leadItems.DTL_RATING}
																	</td>
																	<td>
																	${leadItems.DTL_ENGINE_MODEL}
																	</td>
																	<td>
																	${leadItems.DTL_ALTERNATOR_MODEL}
																	</td>
																	<td>
																	${leadItems.DTL_VOLTAGE}
																	</td>
																	<td>
																	${leadItems.DTL_QTY}
																	</td>
																	<td>
																	${leadItems.DTL_AMOUNT}
																	</td>
																	<td>
																	
																	<a href=javascript:setLeadItem('${leadItems.DTL_ID}','${leadItems.LEAD_ID}','${leadItems.DTL_RATING}','${leadItems.DTL_ENGINE_MODEL}','${leadItems.DTL_ALTERNATOR_MODEL}','${leadItems.DTL_VOLTAGE}','${leadItems.DTL_QTY}','${leadItems.DTL_AMOUNT}','${leadItems.DTL_ENGINE_MAKE}','${leadItems.DTL_COOLING_SYSTEM}','${leadItems.DTL_FLEX1}','${leadItems.DTL_HZ}','${leadItems.DTL_ALTERNATOR_MAKE}','${leadItems.DTL_ENGINE_MODEL}','${leadItems.DTL_FLEX2}')><p class='fa fa-pencil fa-2x'>  </p></a>
																	
								<a href=javascript:deleteLeadItem('${leadItems.DTL_ID}','${leadItems.LEAD_ID}')><p class='fa fa-times fa-2x'>  </p></a>
																	</td>
																	</tr>
																</c:forEach>
